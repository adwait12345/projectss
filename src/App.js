  ...
  return (
    <div className="container">
      ...
      <div className="wrapper">
        <div className="left">
          ...
          <h3>
            ...
            <br /> Service Perfect for launching All Kinds of
            <br /> WordPress Projects!
          </h3>
        </div>
        <div className="right">
          <div className="top">
          ...
          <div className="bottom">
            <span>
              {" "}
              <img src="https://img.icons8.com/ios-filled/16/8B8F9C/lock.png" />
            </span>
            <p>
      ...
      <div className="explore-subscribers">
        ...
        >
          {" "}
          <button>Explore Subscribers</button>{" "}
        </Link>
      </div>
    </div>
  );
